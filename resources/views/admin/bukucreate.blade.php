    ...
    <section class="content">
      ...
      <form action="<?= route('bukustore') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control rounded-0" name="deskripsi" rows="10"></textarea>
        </div>

        <div class="form-group">
            <input onClick="return confirm('Tambahkan data ?')" type="submit" class="btn btn-sm btn-success" value="Kirim">
